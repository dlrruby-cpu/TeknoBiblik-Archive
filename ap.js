// ============================================================
// ap.js - Lógica Oficial de TeknoBiblik™ (Versión 1.1)
// ============================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCarousel() {
        ...
        // Mover el contenedor al slide actual basándose en el contenedor exacto
    ...
    if (readBtn && stopBtn) {
        readBtn.addEventListener('click', () => {
            ...
            const currentSlideTitle = activeSlide.querySelector('h2').innerText;
            
            // Intenta capturar de .speech-target, si no, retrocede al primer <p>
            const speechTarget = activeSlide.querySelector('.speech-target');
            const currentSlideText = speechTarget ? speechTarget.innerText : activeSlide.querySelector('p').innerText;
